...
import { ScrollView, View, Image, Text, Button, StyleSheet, TouchableHighlight } from 'react-native';
...
//   }
// });
export default class SingleRest extends React.Component {
  constructor(props) {
    super(props);
  };

  render() {
    return (<TouchableHighlight onPress={() => this.props.navigator.pop()}>
      <Text>Go Back</Text>
    </TouchableHighlight>)
  }
}
